# This Makefile is for the Padre::Plugin::RunPerlExternal extension to perl.
#
...
#     ABSTRACT => q[Runs perl-document in external window. No need for config-switching]
#     AUTHOR => q[Matthias Ries <riesm@cpan.org>]
#     BUILD_REQUIRES => {  }
#     LICENSE => q[perl]
#     NAME => q[Padre::Plugin::RunPerlExternal]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0] }
#     VERSION_FROM => q[lib/Padre/Plugin/RunPerlExternal.pm]
#     clean => { FILES=>q[Padre-Plugin-RunPerlExternal-*] }
...
MAKE = make
FULLEXT = Padre/Plugin/RunPerlExternal
BASEEXT = RunPerlExternal
...
clean :: clean_subdirs
	- $(RM_F) \
	  ...
	  *$(OBJ_EXT) pm_to_blib \
	  ...
	  $(BASEEXT).exp 
	- $(RM_RF) \
	  Padre-Plugin-RunPerlExternal-* blib 
